...
import com.zhiban.rebuild.data.notification.SenderMuteDao
...
const val AGENT_DATABASE_SCHEMA_VERSION = 53
...
@Database(
    entities = [
        ...
        com.zhiban.rebuild.data.suggestion.AgentSuggestionEntity::class,
    ],
...
internal abstract class AgentDatabase : RoomDatabase() {
    ...
    abstract fun senderMuteDao(): SenderMuteDao
    ...
    abstract fun agentSuggestionDao(): com.zhiban.rebuild.data.suggestion.AgentSuggestionDao
    ...
    companion object {
        ...
        val MIGRATION_46_47 = AgentDatabaseSchema.MIGRATION_46_47
        val MIGRATION_47_48 = AgentDatabaseSchema.MIGRATION_47_48
        ...
        val MIGRATION_52_53 = AgentDatabaseSchema.MIGRATION_52_53
